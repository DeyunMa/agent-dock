...
project_dir="${0:A:h:h}"
package_dir="$project_dir/macos/CodexRouterBar"
...
app_dir="$package_dir/.build/codex-router-app/Codex Router.app"
contents_dir="$app_dir/Contents"

"$project_dir/scripts/build-macos-icon.sh"
...
cp "$bin_dir/CodexRouterBar" "$contents_dir/MacOS/CodexRouterBar"
...
chmod 755 "$contents_dir/MacOS/CodexRouterBar"
