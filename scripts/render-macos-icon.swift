...
// The generated artwork already contains its white squircle and pale rim. This
// mask removes only the outer white canvas so the icon keeps clean corners on
