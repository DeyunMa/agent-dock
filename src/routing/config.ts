...
export function defaultConfig(): RouterConfig {
  return {
    ...
    logging: {
      auditFile: expandHome("~/.codex/router/events.jsonl"),
...
export async function loadConfig(path = process.env.CODEX_ROUTER_CONFIG ?? DEFAULT_CONFIG_PATH): Promise<RouterConfig> {
